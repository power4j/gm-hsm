...
pub const SDR_OK: u32 = 0x0;
pub const SDR_BASE: u32 = 0x01000000;
pub const SDR_UNKNOWERR: u32 = (SDR_BASE + 0x00000001);
pub const SDR_NOTSUPPORT: u32 = (SDR_BASE + 0x00000002);
pub const SDR_COMMFAIL: u32 = (SDR_BASE + 0x00000003);
pub const SDR_HARDFAIL: u32 = (SDR_BASE + 0x00000004);
pub const SDR_OPENDEVICE: u32 = (SDR_BASE + 0x00000005);
pub const SDR_OPENSESSION: u32 = (SDR_BASE + 0x00000006);
pub const SDR_PARDENY: u32 = (SDR_BASE + 0x00000007);
pub const SDR_KEYNOTEXIST: u32 = (SDR_BASE + 0x00000008);
pub const SDR_ALGNOTSUPPORT: u32 = (SDR_BASE + 0x00000009);
pub const SDR_ALGMODNOTSUPPORT: u32 = (SDR_BASE + 0x0000000A);
pub const SDR_PKOPERR: u32 = (SDR_BASE + 0x0000000B);
pub const SDR_SKOPERR: u32 = (SDR_BASE + 0x0000000C);
pub const SDR_SIGNERR: u32 = (SDR_BASE + 0x0000000D);
pub const SDR_VERIFYERR: u32 = (SDR_BASE + 0x0000000E);
pub const SDR_SYMOPERR: u32 = (SDR_BASE + 0x0000000F);
pub const SDR_STEPERR: u32 = (SDR_BASE + 0x00000010);
pub const SDR_FILESIZEERR: u32 = (SDR_BASE + 0x00000011);
pub const SDR_FILENOEXIST: u32 = (SDR_BASE + 0x00000012);
pub const SDR_FILEOFSERR: u32 = (SDR_BASE + 0x00000013);
pub const SDR_KEYTYPEERR: u32 = (SDR_BASE + 0x00000014);
pub const SDR_KEYERR: u32 = (SDR_BASE + 0x00000015);
pub const SDR_ENCDATAERR: u32 = (SDR_BASE + 0x00000016);
pub const SDR_RANDERR: u32 = (SDR_BASE + 0x00000017);
pub const SDR_PRKRERR: u32 = (SDR_BASE + 0x00000018);
pub const SDR_MACERR: u32 = (SDR_BASE + 0x00000019);
pub const SDR_FILEEXSITS: u32 = (SDR_BASE + 0x0000001A);
pub const SDR_FILEWERR: u32 = (SDR_BASE + 0x0000001B);
pub const SDR_NOBUFFER: u32 = (SDR_BASE + 0x0000001C);
pub const SDR_INARGERR: u32 = (SDR_BASE + 0x0000001D);
pub const SDR_OUTARGERR: u32 = (SDR_BASE + 0x0000001E);
