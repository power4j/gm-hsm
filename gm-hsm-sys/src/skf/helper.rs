use crate::sgd::types::BYTE;
use crate::skf::types::{
    DeviceInfo, ECCCipherBlob, ECCPrivateKeyBlob, ECCPublicKeyBlob, ECCSignatureBlob, Version,
};
...
#[cfg(test)]
mod test {
    use crate::sgd::types::{BYTE, ULONG};
    use crate::skf::types::{
        ECCCipherBlob, ECC_MAX_X_COORDINATE_BITS_LEN, ECC_MAX_Y_COORDINATE_BITS_LEN,
    };
